...
<p align="center">
    <b><i>A project to re-implement C++ STL containers for better understanding of data structures and algorithms.</i></b><br>
</p>

<p align="center">
    <img alt="GitHub code size in bytes" src="https://img.shields.io/github/languages/code-size/jdecorte-be/Abstract_data?color=lightblue" />
    <img alt="Number of lines of code" src="https://img.shields.io/tokei/lines/github/jdecorte-be/Abstract_data?color=critical" />
    <img alt="Code language count" src="https://img.shields.io/github/languages/count/jdecorte-be/Abstract_data?color=yellow" />
